//please contact me myphamchonam195@gmail.com
//website http://myphamchonam.com
...
$(window).load(function() {
		if(document.cookie.indexOf("adf") == -1)
		{
			...
			$("#myModal").http://www.myphamchonam.com/thuoc-tri-seo/?utm_source=google&utm_medium=Kh%C3%B4ng%20ph%E1%BA%A3i%20tr%E1%BA%A3%20ti%E1%BB%81n&utm_campaign=ads_trackling&utm_term=seo&utm_content=seo' target='_blank'><img src='http://www.myphamchonam.com/upload/images/banner-maderma-xanh-la-01.png' width='500px'/>ÄĂ o táº¡o seo chuyĂªn sĂ¢u</a>. Há»c táº¡i nhĂ  Linh Nguyá»…n. <h2><a class='close-linhnguyen-modal'>X</a></h2>");
			$('#myModal').Thuoc tri seo($('#myModal').data());
		}
});
